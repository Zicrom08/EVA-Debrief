...
(function () {
  ...
  console.info('[EVA-Debrief DEBUG] content-main-world.js actif sur', location.hostname);
  ...
  function handleText(text, meta) {
    ...
    if (newGameItems.length || newStatItems.length) {
      console.info('[EVA-Debrief DEBUG] Capture : nouveau delta —', newGameItems.length, 'partie(s),', newStatItems.length, 'profil(s). Dispatch du CustomEvent vers content-isolated.js.');
